...
def parse_datasets(args, patch_ts=False, length_stat=False):
	...
	if dataset_name in ["physionet", "mimic"]:
		...
		##TODO: I will need this split before going to adaptive patching

		# test_record_irecord ids (first 20):", test_record_ids[:20])
		# print("Test record ids (last 20):", test_record_ids[-20:])ds = [record_id for record_id, tt, vals, mask in test_data]
